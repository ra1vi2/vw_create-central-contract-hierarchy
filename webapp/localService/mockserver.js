sap.ui.define([
	...
	"use strict";
	var oMockServer,
		_sAppModulePath = "vwks/nlp/s2p/mm/ctrhcentral/create/",
	...
	return {
		...
		init: function () {
			...
			var oUriParameters = new UriParameters(window.location.href),
				...
				sEntity = "xVWKSxNLP_CCTR_C_CNTR_H_CREATE",
		 ...
		 * @returns {sap.ui.core.util.MockServer} returns mockserver of the app
		 */
